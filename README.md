...
Synthetic retail dataset and Microsoft Fabric pipeline for testing [Semantica](https://semantica.ai).
...
and 3.2K SKUs — purpose-built to exercise every Semantica visual and surface 14 planted
insight stories.
...
fabric/             Fabric notebooks, pipelines, semantic model (Week 2+)
