...
bronze_input_subpath: str = "bronze/fact_inventory_daily/fact_inventory_daily.parquet"
silver_table_fqn: str = "CSNP_Silver.silver_fact_inventory_daily"
business_keys: list[str] = ["inventory_key"]
