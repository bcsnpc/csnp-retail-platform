...
bronze_input_subpath: str = "bronze/fact_marketing_spend/fact_marketing_spend.parquet"
silver_table_fqn: str = "CSNP_Silver.silver_fact_marketing_spend"
business_keys: list[str] = ["spend_key"]
