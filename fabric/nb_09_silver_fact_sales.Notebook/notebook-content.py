...
bronze_input_subpath: str = "bronze/fact_sales/fact_sales.parquet"
silver_table_fqn: str = "CSNP_Silver.silver_fact_sales"
business_keys: list[str] = ["sale_key"]
...
bronze_df = spark.read.parquet(bronze_path).drop("late_arrival_days")
