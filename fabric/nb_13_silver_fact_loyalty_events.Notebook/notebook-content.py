...
bronze_input_subpath: str = "bronze/fact_loyalty_events/fact_loyalty_events.parquet"
silver_table_fqn: str = "CSNP_Silver.silver_fact_loyalty_events"
business_keys: list[str] = ["event_key"]
