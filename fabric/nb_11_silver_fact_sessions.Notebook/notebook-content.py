...
bronze_input_subpath: str = "bronze/fact_sessions/fact_sessions.parquet"
silver_table_fqn: str = "CSNP_Silver.silver_fact_sessions"
business_keys: list[str] = ["session_key"]
