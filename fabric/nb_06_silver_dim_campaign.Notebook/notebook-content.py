...
bronze_input_subpath: str = "bronze/dim_campaign/dim_campaign.parquet"
silver_table_fqn: str = "CSNP_Silver.silver_dim_campaign"
business_keys: list[str] = ["campaign_key"]
