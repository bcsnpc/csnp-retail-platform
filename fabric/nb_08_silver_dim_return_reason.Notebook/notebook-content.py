...
bronze_input_subpath: str = "bronze/dim_return_reason/dim_return_reason.parquet"
silver_table_fqn: str = "CSNP_Silver.silver_dim_return_reason"
business_keys: list[str] = ["return_reason_key"]
