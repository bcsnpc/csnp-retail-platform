...
bronze_input_subpath: str = "bronze/dim_customer/dim_customer.parquet"
silver_table_fqn: str = "CSNP_Silver.silver_dim_customer"
# customer_key is the surrogate key — each row is one SCD2 version.
...
business_keys: list[str] = ["customer_key"]
